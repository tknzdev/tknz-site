...
## Pool Config Keys Endpoint

`GET /.netlify/functions/pool-config-keys`

Returns the most recent pool config keys generated by the create-token-meteora workflow (up to 500).
